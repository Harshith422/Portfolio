  ...
  return (
    <section id="about" ref={ref} className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] lg:grid-cols-[1.15fr_0.85fr] gap-12 items-center">
          <motion.div
            ...
            className="relative"
          >
            <div className="relative w-full h-[380px] sm:h-[480px] md:h-[520px] rounded-xl overflow-hidden border border-purple-500/30 shadow-lg shadow-purple-500/10">
              <AboutMeSlideshow />
          ...
          >
            <div className="space-y-4">
              ...
              I am a B.Tech student in Artificial Intelligence Engineering at Amrita Vishwa Vidyapeetham, with a strong interest in applying AI to real-world problems. I have a solid foundation in machine learning, computer vision, and natural language processing, and enjoy building practical, impactful solutions.
              </p>
            </div>
            {/* Highlights section */}
            ...
            <div className="space-y-4">
              <Button asChild className="w-full group relative overflow-hidden">
                <a href="/Resume_Harshith_New.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
              ...
              <Button asChild className="w-full group relative overflow-hidden">
                <a href="/Ai.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 16L7 11M12 16L17 11M12 16V4M4 20H20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  Download Resume (AI Role)
                  <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                </a>
              </Button>
            </div>
